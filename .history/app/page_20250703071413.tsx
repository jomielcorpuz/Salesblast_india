  ...
  const faqs = [
    {
      ...
      answer:
        "You have 2 options on Salesblast. You can purchase domains via Salesblast and either use right away...or age them for use later. Aged domains have quite a few deliverability benefits! You can also use domains that you already own elsewhere on another registrar like GoDaddy or NameCheap. Our team can set up the DNS records for those domains for you and create your inboxes for sending!",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can start sending 2 emails per day per Salesblast account without warming up. However, we strongly recommend warming up your accounts for the best results.",
    },
    {
      question:
