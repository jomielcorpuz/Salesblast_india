...
const ScaledMailClone = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, you can use existing domains if they aren't damaged. That said, we recommend purchasing fresh domains since they generally perform better."
    },
    {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Our expert team handles the complete configuration of your domains with Google and Microsoft inboxes, including all technical DNS settings.",
    ...
    },
    {
      ...
      description: "Choose between immediate sending for urgent campaigns or strategic 2-week warmup for maximum deliverability and volume.",
      icon: <Zap className="w-8 h-8" />
    },
    {
      number: "04",
      title: "Scale with Precision",
      description: "From boutique agencies to enterprise campaigns, our infrastructure scales intelligently with advanced routing and monitoring.",
  ...
  const features = [
    {
      ...
      subtitle: "Optimized accounts across Google, Microsoft, and emerging platforms",
    ...
    },
    {
      ...
      subtitle: "Advanced deliverability engineering for maximum inbox placement",
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <style jsx>{`
        ...
        .mesh-gradient {
          background: radial-gradient(circle at 20% 80%, #667eea 0%, transparent 50%), radial-gradient(circle at 80% 20%, #764ba2 0%, transparent 50%), radial-gradient(circle at 40% 40%, #f093fb 0%, transparent 50%);
        }
      `}</style>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#process" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">Process</a>
      ...
      <section className="relative min-h-screen flex items-center justify-center mesh-gradient">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
          <div className="animate-float">
            <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 mb-8">
              ...
              <span className="text-sm font-medium text-gray-700">Trusted by 10,000+ businesses worldwide</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-blue-600"> predictable revenue machine</span> with
            precision-engineered email infrastructure.
          </p>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-green-600 mb-2">4 Days</div>
        ...
        <div className="absolute top-1/3 right-16 w-16 h-16 bg-purple-500/10 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-12 h-12 bg-pink-500/10 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      </section>

      {/* Auto-scrolling Logo Section */}
      <section className="py-20 bg-gray-50 overflow-hidden">
        <div className="mb-12 text-center">
          <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider">Trusted by industry leaders</p>
        </div>
        <div className="relative">
          <div className="flex animate-scroll">
            {Array.from({ length: 2 }).map((_, setIndex) => (
              <div key={setIndex} className="flex items-center justify-around min-w-full">
                {Array.from({ length: 8 }).map((_, logoIndex) => (
                  <div key={logoIndex} className="mx-12 flex items-center justify-center">
                    <div className="w-32 h-16 bg-white rounded-xl shadow-sm flex items-center justify-center hover-lift border border-gray-100">
                      <span className="text-gray-400 font-semibold text-sm">COMPANY {logoIndex + 1}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group relative">
                <div className={`relative p-8 rounded-3xl border border-gray-100 hover:border-transparent hover:shadow-2xl transition-all duration-500 hover-lift bg-white`}>
      ...
      <section className="py-32 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-2xl text-blue-100 mb-12 max-w-4xl mx-auto">
            Transform your cold outreach into a predictable revenue engine with infrastructure that actually works.
          </p>
      ...
      <section id="process" className="py-32 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 mb-4">Get to 10,000+ emails per month in just days</p>
          </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover-lift border border-gray-100">
                      ...
                      {step.highlight && (
                        <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-blue-200">
                          <p className="text-blue-700 font-semibold">{step.highlight}</p>
                        </div>
                      )}
                      <button className="mt-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-xl hover:shadow-lg transition-all duration-300 font-semibold">
                        Get Started →
                      </button>
                    </div>
                  </div>
      ...
      <section id="faq" className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300">
                <button
