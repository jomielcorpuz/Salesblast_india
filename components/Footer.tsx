        ...
        <motion.div
            ...
            <div className='mt-20'>
                ...
                <div className='flex flex-col sm:flex-row justify-between items-center p-4 gap-4 sm:gap-0'>
                    ...
                    <p className='text-sm font-light text-muted-foreground text-center sm:text-left'>
                        © 2025 Miel Corpuz
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center sm:justify-end gap-3">
                        ...
                        <a aria-label="LinkedIn"
                            href="https://www.linkedin.com/in/jomiel-banogbanog/" target="_blank"
                            className="rounded-full border border-gray-300 dark:border-gray-600 flex items-center justify-center p-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition">
                        ...
                        <a href="mailto:jomielcorpuz@gmail.com"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-mail">
